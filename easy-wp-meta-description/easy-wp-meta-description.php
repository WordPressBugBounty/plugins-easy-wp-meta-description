...
class Easy_WP_Meta_Description{
	...
	function run(){
		if( is_admin() ){
			...
			add_action( 'wp_head', array( $this, 'insert_meta_in_head' ), 1 );
	...
	function front_descr_input(){
		...
		?>
<input type="text" size="40" name="easy_wp_meta_description_front" id="easy_wp_description"
	class="regular-text" value="<?php print esc_attr($setting); ?>">
...
<meta name="description" content="<?php print esc_attr($description); ?>">
<!-- /Easy WP Meta Description -->
...
<textarea class="wp-editor-area" id="easy_wp_description" name="add_description" cols="80" rows="5"><?php
print esc_textarea($value);
?></textarea>
</div>
<p><?php
